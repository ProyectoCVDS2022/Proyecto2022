...
- Además de las funcionalidades anteriormente descritas también tenemos la posibilidad de generar una representación gráfica tanto de las reservas recurrentes como de las reservas canceladas. También podemos consultar la información filtrando entre reservas recurrentes y reservas canceladas. 
![image](https://user-images.githubusercontent.com/25957863/168976329-bf1f960a-5f77-4104-b450-c7cfe9305ee4.png)
- A continuación evidenciamos un gráfico de dona con las respectivas reservas:
