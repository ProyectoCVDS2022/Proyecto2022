...
- **Cerrar Sesión:** 
    - Nos dirigirá a nuestra pantalla principal de elección de usuario (Administrador, Comunidad).
![image](https://user-images.githubusercontent.com/25957863/168936807-57fc7a49-c7a4-4f3e-b70e-6a01157aa065.png)
- **Reservar:** 
    - En este apartado prodemos hacer la búsqueda y posterior reserva de un recurso disponible.
...
- **Mis reservas:** 
    - Otra funcionalidad que posee un usario de la comunidad es el de consultar cada una de las reservas realizadas.
...
- **Aplicación en Heroku**
    - https://dashboard.heroku.com/apps/proyectocicliyos
- **Despliegue continuo**
    - https://proyectocicliyos.herokuapp.com/
